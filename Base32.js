// default alphabet is RFC 4648
(function() {
var std = '23456789abcdefghijkmnpqrstuvwxyz'
var rfc4648 = 'abcdefghijklmnopqrstuvwxyz234567'

 Base32 = (typeof module !== 'undefined' && module !== null ? module.exports : void 0) || (window.Base32 = {});

 Base32.stringify = function (buf, alphabet) {
  if (alphabet == null) alphabet = rfc4648
  return from(base32(buf), b => alphabet[b]).join('')
}

 Base32.parse = function (str, alphabet) {
  if (alphabet == null) alphabet = rfc4648
...
function base32 (buf, arr, offset) {
  Base32.encode.bytes = Math.ceil(buf.length * 8 / 5)
  if (arr == null) arr = new Uint8Array(Base32.encode.bytes); // Buffer.alloc(Base32.encode.bytes)
...
Base32.decode = base256
function base256 (buf, arr, offset) {
  Base32.decode.bytes = Math.floor(buf.length * 5 / 8)
  if (arr == null) arr = new Uint8Array(Base32.decode.bytes); // Buffer.alloc(Base32.decode.bytes)
  if (offset == null) offset = 0
...
Base32.encodingLength = function (buf) {
